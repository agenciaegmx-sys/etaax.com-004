...
/* ════════════════════════════════════════════════════════════════════════════
   ...
   Vive aquí, y no en security.js, por una razón concreta: admin.html NO carga
   security.js, y arrastrarlo entero solo por este diálogo le metería de paso el
   auto-logout por inactividad y el reemplazo de window.alert — dos cambios de
   comportamiento que nadie pidió. modal-dock.js sí lo cargan TODAS las páginas
   que tienen botón de cerrar sesión, y un diálogo es justo lo suyo.
